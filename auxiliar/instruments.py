...
Archivo auxiliar para tratar el error asociado al multímetro.
Contiene los detalles del HP 34401A.
"""
...
class HP34401A(Instrument):
    def __init__(self, specs_path="auxiliar/HP34401A.json", T=23):

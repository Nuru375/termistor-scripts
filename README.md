...
El archivo ".ino" se utilizó para configurar la lectura de temperatura para un termómetro ??.
...
A partir de los datos almacenados en el csv, se debe realizar los ajustes correspondientes y obtener los parámetros "a" y "b" del termistor. Este script no incluye dicho tratamiento.

## Termómetro c/ multímetro HP 34401A
El archivo "TermometroMultimetro.py" se utiliza para medir temperatura una vez caracterizado el termistor (es decir, que se cuenta con los parámetros "a" y "b" del mismo). El mismo calcula de forma automática la incertidumbre asociada a los parámetros del termistor, pero se recomienda adaptar el código para contemplar el error asociado al multímetro.
